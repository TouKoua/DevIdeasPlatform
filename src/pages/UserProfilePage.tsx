                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gray-50 rounded-lg p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-medium text-gray-700">Most Popular Project</span>
                          <ThumbsUpIcon size={16} className="text-gray-500" />
                        </div>
                        {(() => {
                          const mostPopular = userProjects.reduce((prev, current) => 
                            prev.upvotes > current.upvotes ? prev : current
                          );
                          return (
                            <div>
                              <p className="font-medium text-gray-900">{mostPopular.title}</p>
                              <p className="text-sm text-gray-600">{mostPopular.upvotes} upvotes</p>
                            </div>
                          );
                        })()}
                      </div>
